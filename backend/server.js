...
const normalizePort = val => { // renvoi d'un port valide numéro ou chaine de caractère
...
server.listen(port); // écouteur d'événement consignant le port ou le canal nommé pour l'exécution du serveur
